...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      //  home: CacheHelper.getData(key: 'api_token') != null ? const Splash() : Login())
      // ;
      home: const Splash(),
    );
  }
